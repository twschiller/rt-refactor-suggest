...
In this paper we propose a tool evaluation for eliminating the
introduction of code clones during development, and leveraging code
...
describes the user interace for the tool, along with the underlying
