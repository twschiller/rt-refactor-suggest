...
explicitly perform a clone search query.  We believe this is beneficial
because we hypothesize many clones are written without full knowledge 
of existing functionality, so focusing only on copy-and-pasted clones
can ignore many cases where functionality has been inadvertently 
duplicated.
...
%TSM: This is not clear enough.  Are they actually searching through
% a library for similar code fragments, or is it some kind of
% API fill-in?
...
% TSM: Make more clear how these two are different
