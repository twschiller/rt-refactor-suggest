...
frustrating the participant. The participant adapted the code to meet
the specification. Upon implementing the first stage of the image
...
Participant 2 began development by examining 2-line clone that had
...
strategy. Furthermore, the tool can be harmful, as the developer may
waste time discovering that a near-clone is, in fact, behaviorally
