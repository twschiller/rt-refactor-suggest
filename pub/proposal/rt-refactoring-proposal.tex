...
% or regions in the file being maintained. 
...
search. 
The tool is designed so that other clone detectors can be substituted easily.
...
partial clones, the participant \textit{manually} opened the clones in separed
