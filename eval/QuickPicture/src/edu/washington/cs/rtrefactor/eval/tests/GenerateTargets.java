...
public class GenerateTargets {
    ...
    public static void main(String[] args) throws IOException {
        ...
        writeTarget(astronaut, new NewImageTransform(17, new QuickColor(-400, 400, -400, 0)), "Astronaut_new.png");
        writeTarget(puppy, new NewImageTransform(10, new QuickColor(-400, 400, 400, 0)), "Puppy_new.png");

        writeTarget(ghost, new ImageUtil.ShrinkImage(2), "Ghost_shrink.png");

        writeTarget(puppy, new UnderwaterTransform(false), "Puppy_underwater.png");            
        writeTarget(astronaut, new UnderwaterTransform(false), "Astronaut_underwater.png");

        writeTarget(astronaut, new ImageUtil.Flip(), "Astronaut_flip.jpg");
        writeTarget(puppy,  new CartoonifyImageTransform(CartoonStyle.EXPERIMENTAL), "Puppy_cartoon.png");
        writeTarget(astronaut, new VisionImageTransform(50, 50, 500), "Astronaut_vision.png");
        writeTarget(puppy,  new CinematicImageTransform(), "Puppy_movie.png");
