...
run the application, trying a few image transformations.
...
use the value \verb|(0, 0, 0, 0)|.

In the second stage, the transformation
writes the image id indicated by the field \verb|imageId| \testit{in binary} to the lower
