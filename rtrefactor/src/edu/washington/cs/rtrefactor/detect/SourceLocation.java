...
public class SourceLocation implements Comparable<SourceLocation>{
	...
	private void convertLineOffset(IDocument doc)
	{
		try{
			...
			this.globalOffset = off + offset;
		}catch(BadLocationException ex){
			throw new RuntimeException("Error converting line and line offset to global offset", ex);
		}
	}
	...
	private void convertGlobalOffset(IDocument doc)
	{
		try{
			...
			this.offset = globalOffset - lineOff;
		}catch (BadLocationException ex){
			throw new RuntimeException("Error converting global offset to line and line offset", ex);
		}
	}
